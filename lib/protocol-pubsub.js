...
Protocol = module.exports = function(client, con) {
    ...
    this.subscribe = function(model, options, next) {
        console.log('Subscribe: data: ', JSON.stringify(model));
        console.log('Subscribe: opt: ', JSON.stringify(options));
    ...
    this.unsubscribe = function(model, options, next) {
        console.log('Unsubscribe: data: ', JSON.stringify(model));
        console.log('Unsubscribe: opt: ', JSON.stringify(options));
    ...
    this.publish = function(model, options, next) {
        console.log('Publish: data: ', JSON.stringify(model));
        console.log('Publish: opt: ', JSON.stringify(options));
